...
type ContentType = "journal" | "project";
...
export default function NewContentPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const table = contentType === "journal" ? "journals" : "projects";
    
    const insertData = contentType === "journal"
      ? {
    ...
    if (dbError) {
      if (dbError.code === "23505") {
        setError(`A ${contentType} with this slug already exists.`);
      } else {
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <span className="text-text">
              / <Link href="/admin/journals" className="hover:text-accent transition-colors">Content</Link> / New
            </span>
          </div>
        </div>
      </header>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700 mb-8">
          <h3 className="font-semibold text-primary mb-4">Content Type</h3>
          <div className="flex gap-4">
            <button
              type="button"
              onClick={() => setContentType("journal")}
              className={`flex-1 py-4 px-6 rounded-lg font-medium transition-all border-2 ${
                contentType === "journal"
                  ? "border-primary bg-primary/10 text-primary"
                  : "border-gray-200 dark:border-gray-600 text-text hover:border-gray-300"
              }`}
            >
              <div className="text-lg mb-1">📝 Journal</div>
              <div className="text-sm opacity-75">Blog posts, articles, stories</div>
            </button>
            <button
              type="button"
            ...
            >
              <div className="text-lg mb-1">🚀 Project</div>
              <div className="text-sm opacity-75">Portfolio projects, case studies</div>
            </button>
          </div>
        </div>
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700">
                ...
                <input
                  ...
                  placeholder={contentType === "journal" ? "Journal title" : "Project title"}
                />
              </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700">
                ...
                <div className="space-y-6">
                  <ImageUpload
                    ...
                    folder={contentType === "journal" ? "journals/thumbnails" : "projects/thumbnails"}
                    label="Thumbnail"
                  />
                  <ImageUpload
                    value={formData.hero_image}
                    onChange={(url) => updateField("hero_image", url)}
                    folder={contentType === "journal" ? "journals/hero" : "projects/hero"}
                    label="Hero Image"
                  />
                </div>
              </div>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700">
                <MultiImageUpload
                  ...
                  folder={contentType === "journal" ? "journals/gallery" : "projects/gallery"}
                  label="Gallery Images"
                  maxImages={10}
                />
              </div>

              {/* Journal-specific: Location */}
              {contentType === "journal" && (
                <div className="bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700">
              ...
              >
                {loading ? "Creating..." : `Create ${contentType === "journal" ? "Journal" : "Project"}`}
              </button>
            </div>
          </div>
        </form>
