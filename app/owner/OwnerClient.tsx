...
export default function OwnerClient({ ownerProfile }: { ownerProfile: OwnerProfile }) {
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-20 space-y-16 sm:space-y-24">
        <ScrollReveal>
          <section className="space-y-8">
            ...
            <p className="text-lg sm:text-xl md:text-2xl text-text-light dark:text-text-dark leading-relaxed font-light max-w-3xl">
              {ownerProfile.bio}
            </p>
          </section>
        </ScrollReveal>
