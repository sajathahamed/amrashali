...
export default function AboutPage() {
  ...
  const socialLinks = [
    ...
    {
      name: "Instagram",
      url: "https://www.instagram.com/amras_ali23?igsh=aWtuMWZhZmN0MGRk&utm_source=qr",
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: "LinkedIn",
      url: "https://www.linkedin.com/in/amras-ali-6994b1218?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app",
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-20 w-full">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-20 items-center">
            ...
            >
              ...
              >
                A dedicated social work undergraduate committed to empowering
                communities and creating sustainable change.
              </motion.p>
            </motion.div>
          ...
          <section className="space-y-8">
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-lg sm:text-xl md:text-2xl lg:text-3xl leading-relaxed text-text-light font-light mb-6 sm:mb-8">
                ...
                skills and experience in Social services, social media and leading
                projects.
              </p>
              <p className="text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed text-text-light mb-6 sm:mb-8">
                ...
                strength is communication; building strong relationships with
              ...
              <p className="text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed text-text-light">
                Through my work as a social worker, I focus on community-centered
                approaches, environmental conservation, and creating platforms for
                development, inclusion, and empowerment.
              </p>
            </div>
          </section>
        </ScrollReveal>
          ...
          <section id="connect" className="space-y-12">
            ...
            <div className="text-center space-y-8">
              ...
              <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-text-light leading-relaxed font-light max-w-2xl mx-auto px-4">
                Follow my work, connect with me on social media, and join the
                conversation about community development and social change.
              </p>
